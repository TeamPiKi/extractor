...
/**
 * 이 서비스의 클라이언트는 PIKI-Server 워커이고, 빈 이미지·미지원 MIME 은 같은 바이트를 재시도해도 결과가 같으므로
 * 확정 실패(permanent=true → 422)다.
 *
 * <p>팩토리마다 다른 message 는 로그·cause 용이며 응답 body 에는 code 만 나간다.
 */
